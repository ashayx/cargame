...
var MoWan = (function (_super) {
    ...
    function MoWan(config) {
        var _this = _super.call(this) || this;
        _this.key = 'MoWan';
        _this.texture = 'game.moyan';
        _this.config = config;
        _this.init();
        return _this;
    }
    MoWan.prototype.init = function () {
        var m = this.createBitmap('game.moyan');
        this.width = m.width;
    ...
    MoWan.prototype.collide = function (propsBox, bg, car) {
    ...
    MoWan.prototype.remove = function (propsBox) {
        propsBox.removeChild(this);
    };
    return MoWan;
}(Sprite));
